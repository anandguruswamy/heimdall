...
| Slot floor | 1.3 ms | 1.8 ms | 2.4 ms |
| Which limit binds | assembly | reception | reception |
| Cycle at the floor | 2.6 ms | 21.6 ms | 43.2 ms |
| Per-link rate at the floor | 385 Hz | 46 Hz | 23 Hz |
| Links | 2 | 30 | 30 |
...
at 64 taps it stays within 288-454 kB/s, because the radio runs saturated
...
runs at 455 Hz at the floor, which no sensing application needs; the shipped
example configuration sets a 10 ms slot instead, giving a 50 Hz per-link rate and
about 33 kB/s of USB traffic.
